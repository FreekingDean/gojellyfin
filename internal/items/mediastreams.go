...
func (s *Service) ReplaceMediaStreams(ctx context.Context, itemID uuid.UUID, streams []MediaStream) error {
...
func (s *Service) ListMediaStreams(ctx context.Context, itemID uuid.UUID) ([]MediaStream, error) {
