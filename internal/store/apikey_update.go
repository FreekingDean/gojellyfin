...
func (_u *ApiKeyUpdate) Where(ps ...predicate.ApiKey) *ApiKeyUpdate {
	...
	func (_u *ApiKeyUpdate) SetAccessToken(v string) *ApiKeyUpdate {
		...
		func (_u *ApiKeyUpdate) SetNillableAccessToken(v *string) *ApiKeyUpdate {
			if v != nil {
				_u.SetAccessToken(*v)
			}
			return _u
	...
	func (_u *ApiKeyUpdate) SetAppName(v string) *ApiKeyUpdate {
		...
		func (_u *ApiKeyUpdate) SetNillableAppName(v *string) *ApiKeyUpdate {
			if v != nil {
				_u.SetAppName(*v)
			}
			return _u
...
type ApiKeyUpdateOne struct {
	...
	// SetAccessToken sets the "access_token" field.
	func (_u *ApiKeyUpdateOne) SetAccessToken(v string) *ApiKeyUpdateOne {
		_u.mutation.SetAccessToken(v)
		return _u
	}
		...
		// SetNillableAccessToken sets the "access_token" field if the given value is not nil.
		func (_u *ApiKeyUpdateOne) SetNillableAccessToken(v *string) *ApiKeyUpdateOne {
			if v != nil {
				_u.SetAccessToken(*v)
			}
			return _u
	...
	// SetAppName sets the "app_name" field.
	func (_u *ApiKeyUpdateOne) SetAppName(v string) *ApiKeyUpdateOne {
		_u.mutation.SetAppName(v)
		return _u
	}
		...
		// SetNillableAppName sets the "app_name" field if the given value is not nil.
		func (_u *ApiKeyUpdateOne) SetNillableAppName(v *string) *ApiKeyUpdateOne {
			if v != nil {
				_u.SetAppName(*v)
			}
			return _u
...
func (_u *ApiKeyUpdateOne) sqlSave(ctx context.Context) (_node *ApiKey, err error) {
	_spec := sqlgraph.NewUpdateSpec(apikey.Table, apikey.Columns,sqlgraph.NewFieldSpec(apikey.FieldID, field.TypeUUID))
			...
			if !ok {
				return nil, &ValidationError{Name: "id", err: errors.New(`store: missing "ApiKey.id" for update`)}
			}
