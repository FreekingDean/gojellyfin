...
func (_q *UserQuery) Order(o ...user.OrderOption) *UserQuery {
	...
	func (_q *UserQuery) QueryConfiguration() *UserConfigurationQuery {
		query := (&UserConfigurationClient{config: _q.config}).Query()
...
return fromU, nil
	...
	func (_q *UserQuery) QueryPolicy() *UserPolicyQuery {
		query := (&UserPolicyClient{config: _q.config}).Query()
		query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
			if err := _q.prepareQuery(ctx); err != nil {
				return nil, err
			}  
...
return fromU, nil
	...
	// QueryItemData chains the current query on the "item_data" edge.
	func (_q *UserQuery) QueryItemData() *UserItemDataQuery {
...
return fromU, nil
	...
	func (_q *UserQuery) QueryDisplayPreferences() *DisplayPreferencesQuery {
...
return fromU, nil
	...
	func (_q *UserQuery) QueryActivityLogEntries() *ActivityLogEntryQuery {
...
return fromU, nil
	...
	// QueryPlaylistShares chains the current query on the "playlist_shares" edge.
	func (_q *UserQuery) QueryPlaylistShares() *PlaylistShareQuery {
		query := (&PlaylistShareClient{config: _q.config}).Query()
		query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
			if err := _q.prepareQuery(ctx); err != nil {
				return nil, err
			}  
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	func (_q *UserQuery) WithConfiguration(opts ...func(*UserConfigurationQuery)) *UserQuery {
		query := (&UserConfigurationClient{config: _q.config}).Query()
	...
	func (_q *UserQuery) WithPolicy(opts ...func(*UserPolicyQuery)) *UserQuery {
		query := (&UserPolicyClient{config: _q.config}).Query()
		for _, opt := range opts {
			opt(query)
		}
	...
	// WithItemData tells the query-builder to eager-load the nodes that are connected to
	// the "item_data" edge. The optional arguments are used to configure the query builder of the edge.
	func (_q *UserQuery) WithItemData(opts ...func(*UserItemDataQuery)) *UserQuery {
		query := (&UserItemDataClient{config: _q.config}).Query()
		for _, opt := range opts {
			opt(query)
		}
		_q.withItemData = query
		return _q
	}
	...
	func (_q *UserQuery) WithDisplayPreferences(opts ...func(*DisplayPreferencesQuery)) *UserQuery {
		query := (&DisplayPreferencesClient{config: _q.config}).Query()
		for _, opt := range opts {
			opt(query)
		}
	...
	func (_q *UserQuery) WithActivityLogEntries(opts ...func(*ActivityLogEntryQuery)) *UserQuery {
		query := (&ActivityLogEntryClient{config: _q.config}).Query()
		for _, opt := range opts {
			opt(query)
		}
	...
	// WithPlaylistShares tells the query-builder to eager-load the nodes that are connected to
	// the "playlist_shares" edge. The optional arguments are used to configure the query builder of the edge.
	func (_q *UserQuery) WithPlaylistShares(opts ...func(*PlaylistShareQuery)) *UserQuery {
		query := (&PlaylistShareClient{config: _q.config}).Query()
		for _, opt := range opts {
			opt(query)
		}
		_q.withPlaylistShares = query
		return _q
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if len(nodes) == 0 {
		...
		if query := _q.withItemData; query != nil {
			if err := _q.loadItemData(ctx, query, nodes, 
				func(n *User){ n.Edges.ItemData = []*UserItemData{} },
					func(n *User, e *UserItemData){ n.Edges.ItemData = append(n.Edges.ItemData, e) }); err != nil {
				return nil, err
			}
		}
		if query := _q.withDisplayPreferences; query != nil {
			if err := _q.loadDisplayPreferences(ctx, query, nodes, 
				func(n *User){ n.Edges.DisplayPreferences = []*DisplayPreferences{} },
					func(n *User, e *DisplayPreferences){ n.Edges.DisplayPreferences = append(n.Edges.DisplayPreferences, e) }); err != nil {
				return nil, err
			}
		}
		...
		if query := _q.withPlaylistShares; query != nil {
	...
	func (_q *UserQuery) loadConfiguration(ctx context.Context, query *UserConfigurationQuery, nodes []*User, init func(*User), assign func(*User, *UserConfiguration)) error {
			...
			query.Where(predicate.UserConfiguration(func(s *sql.Selector) {
				s.Where(sql.InValues(s.C(user.ConfigurationColumn), fks...))
			}))
			...
			for _, n := range neighbors {
				fk := n.user_configuration
					if fk == nil {
						return fmt.Errorf(`foreign-key "user_configuration" is nil for node %v`, n.ID)
					}
				node, ok := nodeids[*fk]
				if !ok {
					return fmt.Errorf(`unexpected referenced foreign-key "user_configuration" returned %v for node %v`, *fk, n.ID)
				}
				assign(node, n)
			}
		return nil
	}
	func (_q *UserQuery) loadPolicy(ctx context.Context, query *UserPolicyQuery, nodes []*User, init func(*User), assign func(*User, *UserPolicy)) error {
			fks := make([]driver.Value, 0, len(nodes))
			nodeids := make(map[uuid.UUID]*User)
			for i := range nodes {
					fks = append(fks, nodes[i].ID)
			...
			query.Where(predicate.UserPolicy(func(s *sql.Selector) {
				s.Where(sql.InValues(s.C(user.PolicyColumn), fks...))
			}))
			neighbors, err := query.All(ctx)
			if err != nil {
				return err
			...
			for _, n := range neighbors {
				fk := n.user_policy
					if fk == nil {
						return fmt.Errorf(`foreign-key "user_policy" is nil for node %v`, n.ID)
					}
				node, ok := nodeids[*fk]
				if !ok {
					return fmt.Errorf(`unexpected referenced foreign-key "user_policy" returned %v for node %v`, *fk, n.ID)
				}
				assign(node, n)
			}
		return nil
	...
	func (_q *UserQuery) loadItemData(ctx context.Context, query *UserItemDataQuery, nodes []*User, init func(*User), assign func(*User, *UserItemData)) error {
			fks := make([]driver.Value, 0, len(nodes))
			nodeids := make(map[uuid.UUID]*User)
			for i := range nodes {
					fks = append(fks, nodes[i].ID)
	...
	func (_q *UserQuery) loadDisplayPreferences(ctx context.Context, query *DisplayPreferencesQuery, nodes []*User, init func(*User), assign func(*User, *DisplayPreferences)) error {
			fks := make([]driver.Value, 0, len(nodes))
			nodeids := make(map[uuid.UUID]*User)
			for i := range nodes {
					fks = append(fks, nodes[i].ID)
	...
	func (_q *UserQuery) loadActivityLogEntries(ctx context.Context, query *ActivityLogEntryQuery, nodes []*User, init func(*User), assign func(*User, *ActivityLogEntry)) error {
			fks := make([]driver.Value, 0, len(nodes))
			nodeids := make(map[uuid.UUID]*User)
			for i := range nodes {
					fks = append(fks, nodes[i].ID)
			...
			query.Where(predicate.ActivityLogEntry(func(s *sql.Selector) {
				s.Where(sql.InValues(s.C(user.ActivityLogEntriesColumn), fks...))
			}))
			neighbors, err := query.All(ctx)
			if err != nil {
				return err
			...
			for _, n := range neighbors {
				fk := n.user_activity_log_entries
					if fk == nil {
						return fmt.Errorf(`foreign-key "user_activity_log_entries" is nil for node %v`, n.ID)
					}
				node, ok := nodeids[*fk]
				if !ok {
					return fmt.Errorf(`unexpected referenced foreign-key "user_activity_log_entries" returned %v for node %v`, *fk, n.ID)
				}
				assign(node, n)
			}
		return nil
