...
var (
	...
	UserConfigurationsColumns = []*schema.Column{
		...
		{Name: "enable_local_password", Type: field.TypeBool},
		{Name: "hide_played_in_latest", Type: field.TypeBool},
		{Name: "remember_audio_selections", Type: field.TypeBool},
		{Name: "remember_subtitle_selections", Type: field.TypeBool},
	...
	UserPoliciesColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "is_administrator", Type: field.TypeBool},
		{Name: "is_hidden", Type: field.TypeBool},
		{Name: "is_disabled", Type: field.TypeBool},
		{Name: "enable_collection_management", Type: field.TypeBool, Default: false},
		{Name: "enable_subtitle_management", Type: field.TypeBool, Default: false},
		{Name: "enable_lyric_management", Type: field.TypeBool, Default: false},
		{Name: "enable_user_preference_access", Type: field.TypeBool},
		{Name: "enable_remote_control_of_other_users", Type: field.TypeBool},
		{Name: "enable_shared_device_control", Type: field.TypeBool},
		{Name: "enable_remote_access", Type: field.TypeBool},
		{Name: "enable_live_tv_management", Type: field.TypeBool},
		{Name: "enable_live_tv_access", Type: field.TypeBool},
		{Name: "enable_media_playback", Type: field.TypeBool},
		{Name: "enable_audio_playback_transcoding", Type: field.TypeBool},
		{Name: "enable_video_playback_transcoding", Type: field.TypeBool},
		{Name: "enable_playback_remuxing", Type: field.TypeBool},
		{Name: "force_remote_source_transcoding", Type: field.TypeBool},
		{Name: "enable_content_deletion", Type: field.TypeBool},
		{Name: "enable_content_downloading", Type: field.TypeBool},
		{Name: "enable_sync_transcoding", Type: field.TypeBool},
		{Name: "enable_media_conversion", Type: field.TypeBool},
		{Name: "enable_public_sharing", Type: field.TypeBool},
		{Name: "enable_all_devices", Type: field.TypeBool},
		{Name: "enable_all_channels", Type: field.TypeBool},
		{Name: "enable_all_folders", Type: field.TypeBool},
		...
		{Name: "invalid_login_attempt_count", Type: field.TypeInt32},
		{Name: "login_attempts_before_lockout", Type: field.TypeInt32},
		{Name: "max_active_sessions", Type: field.TypeInt32},
		{Name: "remote_client_bitrate_limit", Type: field.TypeInt32},
		...
		{Name: "authentication_provider_id", Type: field.TypeString},
		{Name: "password_reset_provider_id", Type: field.TypeString},
		{Name: "sync_play_access", Type: field.TypeEnum, Enums: []string{"CreateAndJoinGroups", "JoinGroups", "None"}},
		{Name: "user_policy", Type: field.TypeUUID, Nullable: true},
	}
