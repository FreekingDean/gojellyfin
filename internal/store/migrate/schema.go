...
var (
	...
	ImagesColumns = []*schema.Column{
		...
		{Name: "item_images", Type: field.TypeUUID},
	}
	...
	ImagesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "image_kind_index_item_images",
				Unique:  true,
				Columns: []*schema.Column{ImagesColumns[3], ImagesColumns[4], ImagesColumns[10]},
			},
		},
	}
	...
	ItemsColumns = []*schema.Column{
		...
		{Name: "media_type", Type: field.TypeEnum, Enums: []string{"Unknown", "Video", "Audio", "Photo", "Book"}},
		{Name: "location_type", Type: field.TypeEnum, Enums: []string{"FileSystem", "Remote", "Virtual", "Offline"}},
		...
		{Name: "forced_sort_name", Type: field.TypeBool},
		{Name: "path", Type: field.TypeString, Nullable: true},
		{Name: "container", Type: field.TypeString, Nullable: true},
		{Name: "overview", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "is_folder", Type: field.TypeBool},
		{Name: "is_placeholder", Type: field.TypeBool},
		{Name: "lock_data", Type: field.TypeBool},
		{Name: "has_lyrics", Type: field.TypeBool},
		{Name: "has_subtitles", Type: field.TypeBool},
		{Name: "enable_media_source_display", Type: field.TypeBool},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ItemsColumns[54]},
				RefColumns: []*schema.Column{ItemsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "items_libraries_items",
				Columns:    []*schema.Column{ItemsColumns[55]},
	...
	LibrariesColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "name", Type: field.TypeString},
		{Name: "collection_type", Type: field.TypeEnum, Enums: []string{"movies", "tvshows", "music", "musicvideos", "homevideos", "boxsets", "books", "mixed"}},
	...
	LibraryOptionsColumns = []*schema.Column{
		...
		{Name: "enable_photos", Type: field.TypeBool},
		{Name: "enable_realtime_monitor", Type: field.TypeBool},
		{Name: "enable_lufs_scan", Type: field.TypeBool},
		{Name: "enable_chapter_image_extraction", Type: field.TypeBool},
		{Name: "extract_chapter_images_during_library_scan", Type: field.TypeBool},
		{Name: "enable_trickplay_image_extraction", Type: field.TypeBool},
		{Name: "extract_trickplay_images_during_library_scan", Type: field.TypeBool},
		{Name: "save_local_metadata", Type: field.TypeBool},
		{Name: "enable_internet_providers", Type: field.TypeBool},
		{Name: "enable_automatic_series_grouping", Type: field.TypeBool},
		{Name: "enable_embedded_titles", Type: field.TypeBool},
		{Name: "enable_embedded_extras_titles", Type: field.TypeBool},
		{Name: "enable_embedded_episode_infos", Type: field.TypeBool},
		{Name: "skip_subtitles_if_embedded_subtitles_present", Type: field.TypeBool},
		{Name: "skip_subtitles_if_audio_track_matches", Type: field.TypeBool},
		{Name: "require_perfect_subtitle_match", Type: field.TypeBool},
		{Name: "save_subtitles_with_media", Type: field.TypeBool},
		{Name: "save_lyrics_with_media", Type: field.TypeBool},
		{Name: "save_trickplay_with_media", Type: field.TypeBool},
		{Name: "prefer_nonstandard_artists_tag", Type: field.TypeBool},
		{Name: "use_custom_tag_delimiters", Type: field.TypeBool},
		{Name: "automatically_add_to_collection", Type: field.TypeBool},
		{Name: "automatic_refresh_interval_days", Type: field.TypeInt32},
		{Name: "preferred_metadata_language", Type: field.TypeString},
		{Name: "metadata_country_code", Type: field.TypeString},
		{Name: "season_zero_display_name", Type: field.TypeString},
		{Name: "allow_embedded_subtitles", Type: field.TypeEnum, Enums: []string{"AllowAll", "AllowText", "AllowImage", "AllowNone"}},
	...
	MediaSourcesColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "protocol", Type: field.TypeEnum, Enums: []string{"File", "Http", "Rtmp", "Rtsp", "Udp", "Rtp", "Ftp"}},
		{Name: "encoder_protocol", Type: field.TypeEnum, Nullable: true, Enums: []string{"File", "Http", "Rtmp", "Rtsp", "Udp", "Rtp", "Ftp"}},
		{Name: "kind", Type: field.TypeEnum, Enums: []string{"Default", "Grouping", "Placeholder"}},
		...
		{Name: "is_infinite_stream", Type: field.TypeBool},
		{Name: "supports_transcoding", Type: field.TypeBool},
		{Name: "supports_direct_stream", Type: field.TypeBool},
		{Name: "supports_direct_play", Type: field.TypeBool},
		{Name: "supports_probing", Type: field.TypeBool},
		{Name: "read_at_native_framerate", Type: field.TypeBool},
		{Name: "ignore_dts", Type: field.TypeBool},
		{Name: "ignore_index", Type: field.TypeBool},
		{Name: "gen_pts_input", Type: field.TypeBool},
		{Name: "requires_looping", Type: field.TypeBool},
		{Name: "has_segments", Type: field.TypeBool},
		...
		{Name: "item_media_sources", Type: field.TypeUUID},
	}
	...
	MediaStreamsColumns = []*schema.Column{
		...
		{Name: "is_forced", Type: field.TypeBool},
		{Name: "is_external", Type: field.TypeBool},
		{Name: "is_interlaced", Type: field.TypeBool},
		{Name: "is_anamorphic", Type: field.TypeBool},
		{Name: "is_avc", Type: field.TypeBool},
		{Name: "is_hearing_impaired", Type: field.TypeBool},
		{Name: "media_source_streams", Type: field.TypeUUID},
	}
	...
	MediaStreamsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "mediastream_index_media_source_streams",
				Unique:  true,
				Columns: []*schema.Column{MediaStreamsColumns[7], MediaStreamsColumns[54]},
			},
		},
	}
	...
	UserItemDataColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "played", Type: field.TypeBool},
		{Name: "is_favorite", Type: field.TypeBool},
		{Name: "play_count", Type: field.TypeInt32},
		{Name: "playback_position_ticks", Type: field.TypeInt64},
		...
		{Name: "item_user_data", Type: field.TypeUUID},
		{Name: "user_item_data", Type: field.TypeUUID},
	}
	...
	UserItemDataTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "useritemdata_user_item_data_item_user_data",
				Unique:  true,
