...
import (
	...
	func HasConfigurationWith(preds ...predicate.UserConfiguration) predicate.User {
		return predicate.User(func(s *sql.Selector) {
	...
	func HasPolicyWith(preds ...predicate.UserPolicy) predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := newPolicyStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
	...
	// HasItemData applies the HasEdge predicate on the "item_data" edge.
	func HasItemData() predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
				sqlgraph.From(Table, FieldID),
	...
	// HasItemDataWith applies the HasEdge predicate on the "item_data" edge with a given conditions (other predicates).
	func HasItemDataWith(preds ...predicate.UserItemData) predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := newItemDataStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
	...
	func HasActivityLogEntries() predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
				sqlgraph.From(Table, FieldID),
	...
	func HasActivityLogEntriesWith(preds ...predicate.ActivityLogEntry) predicate.User {
		return predicate.User(func(s *sql.Selector) {
	...
	// HasPlaylistShares applies the HasEdge predicate on the "playlist_shares" edge.
	func HasPlaylistShares() predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
				sqlgraph.From(Table, FieldID),
	...
	// HasPlaylistSharesWith applies the HasEdge predicate on the "playlist_shares" edge with a given conditions (other predicates).
	func HasPlaylistSharesWith(preds ...predicate.PlaylistShare) predicate.User {
		return predicate.User(func(s *sql.Selector) {
		step := newPlaylistSharesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
