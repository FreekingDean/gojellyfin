...
func (c *Client) Use(hooks ...Hook) {
		for _, n := range []interface{ Use(...Hook) }{
			c.ActivityLogEntry, c.ApiKey, c.Chapter, c.Credit, c.Device,
 ...
 c.Plugin, c.SeriesTimer, c.Session, c.Studio, c.Timer, c.Trickplay,
...
func (c *PluginClient) mutate(ctx context.Context, m *PluginMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("store: unknown Plugin mutation op: %q", m.Op())
	}
}
...
type (
	...
	hooks struct {
		ActivityLogEntry, ApiKey, Chapter, Credit, Device, DisplayPreferences, Genre,
 Image, Item, Library, LibraryOptions, ListingsProvider, MediaAttachment,
 MediaSegment, MediaSource, MediaStream, Person, Playlist, PlaylistEntry,
 PlaylistShare, Plugin, SeriesTimer, Session, Studio, Timer, Trickplay,
 TunerHost, User, UserConfiguration, UserItemData, UserPolicy []ent.Hook
	}
	inters struct {
		ActivityLogEntry, ApiKey, Chapter, Credit, Device, DisplayPreferences, Genre,
 Image, Item, Library, LibraryOptions, ListingsProvider, MediaAttachment,
 MediaSegment, MediaSource, MediaStream, Person, Playlist, PlaylistEntry,
 PlaylistShare, Plugin, SeriesTimer, Session, Studio, Timer, Trickplay,
 TunerHost, User, UserConfiguration, UserItemData, UserPolicy []ent.Interceptor
	}
)
